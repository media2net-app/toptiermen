...
VALUES 
  (CURRENT_DATE - INTERVAL '6 days', 4, 3, true, true, 10, 30, 8500, 2.0, 7.5, 8, 'Goede dag, veel energie'),
  (CURRENT_DATE - INTERVAL '5 days', 5, 4, true, true, 15, 45, 12000, 2.5, 8.0, 9, 'Uitstekende dag, alle doelen behaald'),
  (CURRENT_DATE - INTERVAL '4 days', 3, 2, false, true, 5, 20, 6000, 1.5, 6.5, 6, 'Moeilijke dag, weinig energie'),
  (CURRENT_DATE - INTERVAL '3 days', 4, 3, true, true, 10, 35, 9500, 2.0, 7.0, 7, 'Herstel dag, voel me beter'),
  (CURRENT_DATE - INTERVAL '2 days', 5, 4, true, true, 15, 40, 11000, 2.5, 7.5, 8, 'Productieve dag'),
  (CURRENT_DATE - INTERVAL '1 day', 4, 3, true, true, 10, 30, 9000, 2.0, 7.0, 7, 'Stabiele dag'),
  (CURRENT_DATE, 2, 2, false, false, 10, 0, 0, 0.5, 0, 0, 'Dag nog niet afgelopen');

-- Chiel's daily progress for the last 7 days
INSERT INTO user_daily_progress (user_id, date, missions_completed, habits_completed, training_completed, nutrition_tracked, meditation_minutes, reading_minutes, steps_count, water_intake_liters, sleep_hours, mood_rating, notes)
VALUES 
  (CURRENT_DATE - INTERVAL '6 days', 3, 2, false, false, 5, 20, 7000, 1.5, 7.0, 7, 'Eerste dag, nog aan het wennen'),
  (CURRENT_DATE - INTERVAL '5 days', 4, 3, true, true, 5, 25, 8500, 2.0, 7.5, 8, 'Beter dan gisteren'),
  (CURRENT_DATE - INTERVAL '4 days', 2, 1, false, false, 0, 0, 4000, 1.0, 6.0, 5, 'Moeilijke dag'),
  (CURRENT_DATE - INTERVAL '3 days', 3, 2, false, true, 5, 15, 6000, 1.5, 7.0, 6, 'Langzaam herstel'),
  (CURRENT_DATE - INTERVAL '2 days', 4, 3, true, true, 5, 20, 8000, 2.0, 7.5, 7, 'Goede dag'),
  (CURRENT_DATE - INTERVAL '1 day', 3, 2, false, true, 5, 15, 7500, 1.5, 7.0, 7, 'Stabiel'),
  (CURRENT_DATE, 2, 1, false, false, 5, 0, 0, 0.5, 0, 0, 'Dag nog niet afgelopen');
...
VALUES 
  (CURRENT_DATE - INTERVAL '4 weeks', 28, 25, 5, 70, 210, 70000, 7.5, 280),
  (CURRENT_DATE - INTERVAL '3 weeks', 30, 28, 6, 75, 225, 75000, 8.0, 300),
  (CURRENT_DATE - INTERVAL '2 weeks', 25, 22, 4, 60, 180, 65000, 7.0, 250),
  (CURRENT_DATE - INTERVAL '1 week', 29, 26, 5, 70, 210, 72000, 7.8, 290);

-- Chiel's weekly stats
INSERT INTO user_weekly_stats (user_id, week_start_date, missions_completed, habits_completed, training_sessions, meditation_minutes, reading_minutes, total_steps, average_mood, points_earned)
VALUES 
  (CURRENT_DATE - INTERVAL '4 weeks', 15, 10, 2, 20, 60, 40000, 6.0, 150),
  (CURRENT_DATE - INTERVAL '3 weeks', 18, 12, 3, 25, 75, 45000, 6.5, 180),
  (CURRENT_DATE - INTERVAL '2 weeks', 20, 15, 3, 30, 90, 50000, 7.0, 200),
  (CURRENT_DATE - INTERVAL '1 week', 22, 18, 4, 35, 105, 55000, 7.2, 220);
...
VALUES 
  ...
  ('061e43d5-c89a-42bb-8a4c-04be2ce99a7e', 'milestone', '50 Missions Completed', 'Voltooide 50 missies', '🎯', '{"total_missions": 50}'),
...
-- =====================================================
-- 12. UPDATE USERS TABLE WITH DASHBOARD DATA
-- =====================================================

-- Update Rick's user data
UPDATE users 
SET 
  points = 1250,
  missions_completed = 156,
