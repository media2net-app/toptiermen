-- Insert Training Schemas with Days and Exercises
...
BEGIN
  ...
  VALUES
    ...
    (day3_id, 'Upright Rows', 3, '10-12', '90 sec', 6, 'Trapezius focus');

  -- Insert exercises for Arms Day
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day4_id, 'Bicep Curls', 4, '8-10', '90 sec', 1, 'Bicep compound'),
    (day4_id, 'Hammer Curls', 3, '10-12', '90 sec', 2, 'Bicep variatie'),
    (day4_id, 'Preacher Curls', 3, '10-12', '90 sec', 3, 'Bicep isolatie'),
    (day4_id, 'Tricep Pushdowns', 4, '10-12', '90 sec', 4, 'Tricep compound'),
    (day4_id, 'Tricep Dips', 3, '8-12', '90 sec', 5, 'Tricep compound'),
    (day4_id, 'Skull Crushers', 3, '10-12', '90 sec', 6, 'Tricep isolatie');

  -- Insert exercises for Legs Day
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day5_id, 'Squat', 4, '6-8', '180 sec', 1, 'Been kracht'),
    (day5_id, 'Leg Press', 3, '8-10', '120 sec', 2, 'Quadriceps focus'),
    (day5_id, 'Romanian Deadlift', 3, '8-10', '120 sec', 3, 'Hamstrings'),
    (day5_id, 'Leg Extensions', 3, '12-15', '90 sec', 4, 'Quadriceps isolatie'),
...
BEGIN
  ...
  VALUES (
    ...
    'Intensieve 6-daags schema voor ervaren lifters. Dubbele PPL cyclus per week.',
    'Gym',
    '/images/mind/5.png',
    'published',
    'Advanced',
  ...
  INSERT INTO training_schema_days (schema_id, day_number, name, description, focus_area, order_index)
  VALUES
    (schema_id, 1, 'Push A', 'Dag 1: Borst en triceps focus - zware compound bewegingen.', 'Push A (Borst, Triceps)', 1),
    (schema_id, 2, 'Pull A', 'Dag 2: Rug en biceps focus - zware compound bewegingen.', 'Pull A (Rug, Biceps)', 2),
    (schema_id, 3, 'Legs A', 'Dag 3: Benen focus - zware compound bewegingen.', 'Legs A (Quadriceps, Hamstrings)', 3),
    (schema_id, 4, 'Push B', 'Dag 4: Schouders en triceps focus - isolatie en volume.', 'Push B (Schouders, Triceps)', 4),
    (schema_id, 5, 'Pull B', 'Dag 5: Rug en biceps focus - isolatie en volume.', 'Pull B (Rug, Biceps)', 5),
    (schema_id, 6, 'Legs B', 'Dag 6: Benen focus - isolatie en volume.', 'Legs B (Glutes, Calves)', 6)
  RETURNING id INTO day1_id;
  ...
  -- Insert exercises for Push A (Heavy)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day1_id, 'Bench Press', 4, '5-7', '180 sec', 1, 'Zware compound'),
    (day1_id, 'Overhead Press', 3, '6-8', '180 sec', 2, 'Schouder kracht'),
    (day1_id, 'Incline Bench Press', 3, '6-8', '120 sec', 3, 'Bovenste borst'),
    (day1_id, 'Dumbbell Press', 3, '8-10', '120 sec', 4, 'Borst stabiliteit'),
    (day1_id, 'Tricep Dips', 3, '6-10', '120 sec', 5, 'Tricep compound'),
    (day1_id, 'Tricep Pushdowns', 3, '10-12', '90 sec', 6, 'Tricep isolatie');

  -- Insert exercises for Pull A (Heavy)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day2_id, 'Deadlift', 4, '4-6', '240 sec', 1, 'Zware rug kracht'),
    (day2_id, 'Pull-ups', 4, '5-8', '180 sec', 2, 'Rug breedte'),
    (day2_id, 'Barbell Row', 3, '6-8', '180 sec', 3, 'Rug dikte'),
    (day2_id, 'Lat Pulldown', 3, '8-10', '120 sec', 4, 'Rug isolatie'),
    (day2_id, 'Bicep Curls', 3, '8-10', '120 sec', 5, 'Bicep compound'),
    (day2_id, 'Hammer Curls', 3, '10-12', '90 sec', 6, 'Bicep variatie');

  -- Insert exercises for Legs A (Heavy)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day3_id, 'Squat', 4, '5-7', '240 sec', 1, 'Zware been kracht'),
    (day3_id, 'Romanian Deadlift', 3, '6-8', '180 sec', 2, 'Hamstring kracht'),
    (day3_id, 'Leg Press', 3, '8-10', '180 sec', 3, 'Quadriceps kracht'),
    (day3_id, 'Leg Extensions', 3, '10-12', '120 sec', 4, 'Quadriceps isolatie'),
    (day3_id, 'Leg Curls', 3, '10-12', '120 sec', 5, 'Hamstring isolatie'),
    (day3_id, 'Standing Calf Raises', 4, '12-15', '90 sec', 6, 'Kuit kracht');

  -- Insert exercises for Push B (Volume)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day4_id, 'Dumbbell Shoulder Press', 4, '8-12', '120 sec', 1, 'Schouder volume'),
    (day4_id, 'Lateral Raises', 4, '12-15', '90 sec', 2, 'Schouder breedte'),
    (day4_id, 'Front Raises', 3, '12-15', '90 sec', 3, 'Voorste deltavleugel'),
    (day4_id, 'Rear Delt Flyes', 3, '12-15', '90 sec', 4, 'Achterste deltavleugel'),
    (day4_id, 'Cable Flyes', 3, '12-15', '90 sec', 5, 'Borst volume'),
    (day4_id, 'Tricep Extensions', 3, '12-15', '90 sec', 6, 'Tricep volume');

  -- Insert exercises for Pull B (Volume)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day5_id, 'Seated Cable Row', 4, '10-12', '120 sec', 1, 'Rug volume'),
    (day5_id, 'T-Bar Row', 3, '10-12', '120 sec', 2, 'Rug dikte'),
    (day5_id, 'Face Pulls', 3, '12-15', '90 sec', 3, 'Schouder gezondheid'),
    (day5_id, 'Preacher Curls', 3, '10-12', '90 sec', 4, 'Bicep isolatie'),
    (day5_id, 'Concentration Curls', 3, '12-15', '90 sec', 5, 'Bicep volume'),
    (day5_id, 'Reverse Flyes', 3, '12-15', '90 sec', 6, 'Achterste deltavleugel');

  -- Insert exercises for Legs B (Volume)
  INSERT INTO training_schema_exercises (schema_day_id, exercise_name, sets, reps, rest_time, order_index, notes)
  VALUES
    (day6_id, 'Hip Thrusts', 4, '10-12', '120 sec', 1, 'Glute focus'),
    (day6_id, 'Walking Lunges', 3, '12 per been', '120 sec', 2, 'Unilaterale training'),
    (day6_id, 'Good Mornings', 3, '10-12', '120 sec', 3, 'Posterior chain'),
    (day6_id, 'Leg Extensions', 3, '15-20', '90 sec', 4, 'Quadriceps volume'),
    (day6_id, 'Leg Curls', 3, '15-20', '90 sec', 5, 'Hamstring volume'),
    (day6_id, 'Seated Calf Raises', 4, '20-25', '60 sec', 6, 'Kuit volume');
END $$; 