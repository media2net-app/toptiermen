...
async function createRickDirect() {
  console.log('🔧 CREATING RICK@TOPTIERMEN.EU DIRECTLY...\n');

  try {
    // 1. First, let's try to delete any existing rick@toptiermen.eu if it exists
    console.log('1️⃣ Attempting to delete any existing rick@toptiermen.eu...');
    ...
    if (existingRick) {
      console.log('⚠️ Found existing rick@toptiermen.eu, deleting...');
      ...
      console.log('✅ No existing rick@toptiermen.eu found');
    }
    ...
    if (authError2) {
      ...
      console.log('   - Status:', authError2.status);
      console.log('   - Message:', authError2.message);
      return;
    }
    ...
    console.log('\n🎉 RICK@TOPTIERMEN.EU CREATED SUCCESSFULLY!');
