...
async function completeAllAcademyLessons() {
  ...
  try {
    ...
    // First, create the academy_lesson_completions table if it doesn't exist
    console.log('\n🔧 Creating academy_lesson_completions table...');
    ...
    if (createTableError) {
      console.log('❌ Error creating tables:', createTableError.message);
