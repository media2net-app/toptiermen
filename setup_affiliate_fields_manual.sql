-- =====================================================
-- MANUAL SETUP: ADD AFFILIATE FIELDS TO PROFILES TABLE
-- =====================================================
-- 
-- Copy and paste this entire script into the Supabase SQL Editor
-- and click "Run" to add the affiliate fields to your profiles table.
--
...
-- Verify the setup
SELECT 
  'affiliate_code' as column_name,
  affiliate_code as sample_value
FROM profiles 
LIMIT 1; 