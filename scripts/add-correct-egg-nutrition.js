...
// Correcte voedingswaarden gebaseerd op Voedingscentrum data
const correctEggNutrition = [
  {
    ...
    description: '1 rauw ei (50g) - Rijk aan eiwitten en gezonde vetten volgens Voedingscentrum',
    is_active: true
  },
  {
    name: '1 Ei (gekookt)',
    ...
    description: '1 gekookt ei (50g) - Perfecte bron van eiwitten volgens Voedingscentrum',
    is_active: true
  },
  {
    name: '1 Ei (gebakken)',
    ...
    description: '1 gebakken ei (50g) - Hogere calorieën door toegevoegd vet volgens Voedingscentrum',
    is_active: true
  }
];

async function addCorrectEggNutrition() {
  try {
    console.log('🥚 Adding correct egg nutrition values based on Voedingscentrum...\n');

    for (const eggData of correctEggNutrition) {
      console.log(`📝 Processing: ${eggData.name}`);
    ...
    console.error('❌ Error adding correct egg nutrition:', error);
  }
}

addCorrectEggNutrition();
