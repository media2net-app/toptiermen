...
// Facebook page ID for Top Tier Men
const FACEBOOK_PAGE_ID = '610571295471584'; // Top Tier Men Facebook page

console.log(`📊 Using Facebook Page ID: ${FACEBOOK_PAGE_ID}`);

// All campaign configurations with page ID
const ALL_CAMPAIGNS = {
  algemene: {
...
async function createAllCampaignsWithPageId() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (With Page ID)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);
  console.log(`📊 Facebook Page ID: ${FACEBOOK_PAGE_ID}\n`);

  // Facebook page ID is configured correctly

  try {
    console.log('📹 Campaigns will be created with page-linked creatives\n');
    ...
    for (const [campaignKey, campaignData] of Object.entries(ALL_CAMPAIGNS)) {
      ...
      console.log(`📊 Page ID: ${campaignWithAdAccount.page_id}`);
    ...
    console.log('3. Add images to ad creatives manually');
