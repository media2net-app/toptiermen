...
// Text-only ad creatives for each campaign type
const AD_CREATIVES = {
  zakelijk: [
    {
      name: 'TTM - Zakelijk - Entrepreneurs & Leaders - LEADS - Text Ad 1',
    ...
    {
      name: 'TTM - Zakelijk - Business Professionals - LEADS - Text Ad 2',
  ...
  vaders: [
    {
      name: 'TTM - Vaders - Role Model & Success - LEADS - Text Ad 1',
    ...
    {
      name: 'TTM - Vaders - Family & Leadership - LEADS - Text Ad 2',
  ...
  jongeren: [
    {
      name: 'TTM - Jongeren - Social & Community - LEADS - Text Ad 1',
    ...
    {
      name: 'TTM - Jongeren - Fitness & Lifestyle - LEADS - Text Ad 2',
  ...
  algemeen: [
    {
      name: 'TTM - Algemeen - Custom Audience - LEADS - Text Ad 1',
...
async function createTextAdCreative(creativeConfig) {
  try {
    ...
    console.log(`✅ Created text ad creative: ${creativeConfig.name} (ID: ${creativeData.id})`);
...
async function setupLeadsCampaign(campaign) {
  ...
  // Step 2: Create text ad creatives
  console.log(`🎨 Creating ${adCreatives.length} text ad creatives...`);
  
  const createdCreatives = [];
  for (const creativeConfig of adCreatives) {
    const creativeId = await createTextAdCreative(creativeConfig);
    if (creativeId) {
...
async function main() {
  console.log('🚀 Setting up complete LEADS campaigns with text-only ad creatives...\n');
  ...
  results.forEach((result, index) => {
    ...
    console.log(`   - Text ad creatives created: ${result.creatives.length}`);
  ...
  console.log('4. Review and approve text ad creatives');
  console.log('5. Add images to ad creatives if needed');
  console.log('6. Activate campaigns when ready');
