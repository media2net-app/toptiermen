...
console.log('🍽️ INSERTING NUTRITION PLANS MINIMAL');
console.log('============================================================');
...
async function insertPlansMinimal() {
  try {
    console.log('📋 STEP 1: Inserting nutrition plans (minimal version)');
    console.log('----------------------------------------');
    
    // Insert the nutrition plans with only basic columns
