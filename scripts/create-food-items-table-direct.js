...
async function createFoodItemsTableDirect() {
  console.log('🔧 Creating food_items table directly...');
  ...
  try {
    ...
    if (existingError && existingError.code === '42P01') {
      ...
      // we'll use a different approach - create a migration file
...
ALTER TABLE food_items DISABLE ROW LEVEL SECURITY;
    ...
    if (insertError) {
      ...
      console.log('⚠️ Please create the table first using the SQL above');
    } else {
