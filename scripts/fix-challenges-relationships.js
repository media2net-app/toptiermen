...
async function fixChallengesRelationships() {
  console.log('🔧 Fixing Challenges Relationships...\n');
  ...
  try {
    ...
    // Create user_challenges table with proper foreign key
    ...
    // Create challenge_logs table with proper foreign keys
    ...
    const indexes = [
      'CREATE INDEX idx_challenges_category ON challenges(category_slug);',
      'CREATE INDEX idx_challenges_status ON challenges(status);',
      'CREATE INDEX idx_user_challenges_user ON user_challenges(user_id);',
      'CREATE INDEX idx_user_challenges_status ON user_challenges(status);',
      'CREATE INDEX idx_challenge_logs_user ON challenge_logs(user_id);',
      'CREATE INDEX idx_challenge_logs_challenge ON challenge_logs(challenge_id);',
      'CREATE INDEX idx_challenge_logs_date ON challenge_logs(activity_date);'
    ];
    ...
    console.log('\n🎉 Challenges relationships fixed successfully!');
    console.log('📊 Tables recreated with proper foreign key relationships');
