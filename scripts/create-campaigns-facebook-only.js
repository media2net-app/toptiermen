...
async function createCampaignsFacebookOnly() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (Facebook Page Only)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);

  try {
    console.log('📝 Campaigns will be created with Facebook page linking only\n');
