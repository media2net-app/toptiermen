...
// Facebook page and Instagram account IDs
const FACEBOOK_PAGE_ID = '610571295471584'; // Top Tier Men
const INSTAGRAM_ACCOUNT_ID = '17841472149652019'; // @toptiermen.eu

console.log(`📊 Facebook Page ID: ${FACEBOOK_PAGE_ID}`);
console.log(`📊 Instagram Account ID: ${INSTAGRAM_ACCOUNT_ID}`);

// All campaign configurations with page and Instagram linking
const ALL_CAMPAIGNS = {
  algemene: {
...
async function createCampaignsWithPageAndInstagram() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (With Page & Instagram)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);

  try {
    console.log('📝 Campaigns will be created with Facebook page and Instagram account linking\n');
    ...
    for (const [campaignKey, campaignData] of Object.entries(ALL_CAMPAIGNS)) {
      ...
      console.log(`📊 Instagram Account: ${campaignWithAdAccount.instagram_actor_id}`);
...
// Run the script
createCampaignsWithPageAndInstagram()
  .then(() => {
    console.log('\n✅ Script completed');
    process.exit(0);
  })
