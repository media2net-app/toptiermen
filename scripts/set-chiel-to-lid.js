...
async function setChielToLid() {
  console.log('🔧 Setting Chiel\'s role from ADMIN to LID...\n');
  ...
  try {
    ...
    if (currentProfile.role === 'lid') {
      console.log('✅ Chiel already has LID role - no change needed!');
      return;
    }
    ...
    if (verifyProfile.role === 'lid') {
      console.log('✅ SUCCESS: Chiel now has LID role!');
    } else {
