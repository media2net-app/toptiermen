...
// All campaign configurations without videos
const ALL_CAMPAIGNS = {
  algemene: {
...
async function createAllCampaignsToFacebook() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (No Videos)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);

  try {
    console.log('📹 Campaigns will be created with image creatives (no videos)\n');
