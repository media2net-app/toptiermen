...
async function createAdSet(campaignId, adSetConfig) {
  try {
    ...
    // Using a simpler approach with minimal required fields
...
async function setupLeadsCampaign(campaign) {
  ...
  for (const adSetConfig of adSetConfigs) {
    ...
    // Wait 3 seconds between ad sets
...
async function main() {
  console.log('🚀 Creating ad sets for LEADS campaigns (simplified approach)...\n');
