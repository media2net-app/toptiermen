...
// Campaign configurations without ad creatives
const ALL_CAMPAIGNS = {
  algemene: {
...
async function createCampaignsWithoutCreatives() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (Without Ad Creatives)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);

  try {
    console.log('📝 Campaigns will be created without ad creatives\n');
    ...
    console.log('7. Monitor performance and adjust as needed');
    console.log('8. Focus on email collection for the prelaunch waitlist');
...
// Run the script
createCampaignsWithoutCreatives()
  .then(() => {
    console.log('\n✅ Script completed');
    process.exit(0);
  })
