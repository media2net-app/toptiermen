...
const newBooks = [
  {
    ...
    description: "Wat de rijken hun kinderen leren over geld dat de armen en de middenklasse niet doen. Een revolutionaire kijk op financiële educatie en het verschil tussen activa en passiva.",
    status: "published",
    average_rating: 4.5,
    review_count: 15
  },
