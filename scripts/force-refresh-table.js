...
async function forceRefreshTable() {
  try {
    console.log('🚀 Force refresh van nutrition_plans tabel...');
    
    // First, try to drop the table if it exists
    console.log('🗑️  Proberen bestaande tabel te droppen...');
    ...
    if (dropError) {
      console.log('⚠️  Kon tabel niet droppen via RPC, ga door...');
    } else {
