...
// Extensive ebook content for Module 1: Testosteron
const testosteronEbookContent = {
  'Wat is Testosteron': `
    ...
    <ol>
      <li><strong>Testosteron Dagboek:</strong> Houd een week lang bij hoe je je voelt, je energieniveau, en je motivatie</li>
      <li><strong>Lichaamsscan:</strong> Evalueer je huidige fysieke en mentale staat</li>
      <li><strong>Doelstellingen:</strong> Stel concrete doelen voor testosteron optimalisatie</li>
    </ol>
    
    <h3>Reflectie Vragen:</h3>
    <ul>
      <li>Hoe voel je je momenteel fysiek en mentaal?</li>
      <li>Welke symptomen van lage testosteron herken je bij jezelf?</li>
      <li>Wat zijn je belangrijkste doelen voor hormoon optimalisatie?</li>
    </ul>
  ...
  'De Kracht van Hoog Testosteron': `
    ...
    <h3>Praktische Oefeningen:</h3>
    <ol>
      <li><strong>Voordelen Inventarisatie:</strong> Maak een lijst van welke voordelen je het meest aanspreken</li>
      <li><strong>Visie Oefening:</strong> Visualiseer hoe je leven eruit zou zien met optimale testosteronwaarden</li>
      <li><strong>Actieplan:</strong> Stel concrete stappen op om je testosteron te optimaliseren</li>
    </ol>
    
    <h3>Reflectie Vragen:</h3>
    <ul>
      <li>Welke voordelen van hoge testosteron spreeken je het meest aan?</li>
      <li>Hoe zou je leven veranderen met optimale hormoonwaarden?</li>
      <li>Welke gebieden van je leven zouden het meest verbeteren?</li>
    </ul>
  ...
  'Testosteron Killers: Wat moet je Elimineren': `
    ...
    <h3>Praktische Oefeningen:</h3>
    <ol>
      <li><strong>Testosteron Killers Audit:</strong> Evalueer welke factoren jouw testosteron beïnvloeden</li>
      <li><strong>Eliminatie Plan:</strong> Maak een stapsgewijs plan om testosteron killers te verwijderen</li>
      <li><strong>Vervangingsstrategie:</strong> Bedenk gezonde alternatieven voor slechte gewoonten</li>
    </ol>
    
    <h3>Reflectie Vragen:</h3>
    <ul>
      <li>Welke testosteron killers heb je in je leven?</li>
      <li>Welke zijn het moeilijkst om te elimineren?</li>
      <li>Hoe kun je deze factoren stap voor stap aanpakken?</li>
    </ul>
  ...
  'TRT en mijn Visie': `
    ...
    <h3>Praktische Oefeningen:</h3>
    <ol>
      <li><strong>Natuurlijke Optimalisatie Plan:</strong> Maak een 90-dagen plan voor natuurlijke testosteron optimalisatie</li>
      <li><strong>Medische Consultatie Voorbereiding:</strong> Stel vragen op voor je arts</li>
      <li><strong>Risico-Baten Analyse:</strong> Weeg de voor- en nadelen van TRT af</li>
    </ol>
    
    <h3>Reflectie Vragen:</h3>
    <ul>
      <li>Heb je alle natuurlijke methoden uitgeprobeerd?</li>
      <li>Wat zijn je motieven voor het overwegen van TRT?</li>
      <li>Ben je bereid om de risico's te accepteren?</li>
    </ul>
  ...
  'De Waarheid over Testosteron Doping': `
    ...
    <ul>
      <li>Resultaten zijn vaak tijdelijk</li>
      <li>Je moet nog steeds hard trainen en goed eten</li>
      <li>Risico's zijn reëel en kunnen levenslang zijn</li>
      <li>Illegaal gebruik kan leiden tot strafrechtelijke vervolging</li>
      <li>De meeste gebruikers krijgen niet de resultaten die ze verwachten</li>
    </ul>
    
    <h3>Alternatieven voor Steroïden:</h3>
    <ul>
      <li><strong>Natuurlijke Testosteron Optimalisatie:</strong> Levensstijl, voeding, training</li>
      <li><strong>Legale Supplementen:</strong> Vitamine D, zink, magnesium, ashwagandha</li>
      <li><strong>Geavanceerde Training Methoden:</strong> Progressive overload, periodisering</li>
      <li><strong>Optimalisatie van Herstel:</strong> Slaap, stress management, voeding</li>
    </ul>
    
    <h3>Mijn Visie op Doping:</h3>
    <p>Als coach en mentor, raad ik het gebruik van anabole steroïden ten zeerste af. De risico's wegen zelden op tegen de voordelen, en er zijn altijd betere, veiligere alternatieven.</p>
    
    <h3>Praktische Oefeningen:</h3>
    <ol>
      <li><strong>Motivatie Analyse:</strong> Onderzoek waarom je overweegt om steroïden te gebruiken</li>
      <li><strong>Alternatieven Onderzoek:</strong> Zoek naar natuurlijke methoden voor je doelen</li>
      <li><strong>Risico Evaluatie:</strong> Weeg de risico's af tegen de potentiële voordelen</li>
    </ol>
    
    <h3>Reflectie Vragen:</h3>
    <ul>
      <li>Waarom overweeg je het gebruik van steroïden?</li>
      <li>Heb je alle natuurlijke alternatieven uitgeprobeerd?</li>
      <li>Ben je bereid om de risico's te accepteren?</li>
      <li>Wat zijn je langetermijndoelen?</li>
    </ul>
    
    <h3>De Bottom Line:</h3>
    <p>Er is geen snelle weg naar succes. Echte, duurzame resultaten komen van consistentie, geduld, en hard werk. Focus op het optimaliseren van je natuurlijke potentieel in plaats van te zoeken naar shortcuts.</p>
    
    <p><strong>Mijn advies:</strong> Investeer in jezelf door te leren hoe je je lichaam natuurlijk kunt optimaliseren. De resultaten zullen misschien langzamer komen, maar ze zullen duurzamer zijn en je gezondheid beschermen.</p>
  `
};

// HTML template for extensive ebooks
function generateExtensiveEbookHTML(lessonTitle, moduleTitle, moduleNumber, lessonContent, lessonDescription, lessonDuration, lessonType) {
  return `<!DOCTYPE html>
<html lang="nl">
<head>
    <meta charset="UTF-8">
...
async function restoreExtensiveEbookContent() {
  try {
    console.log('📚 RESTORING EXTENSIVE EBOOK CONTENT');
    console.log('====================================\n');
    ...
    // Get all lessons for Testosteron module
    ...
    for (const lesson of lessons) {
      ...
      // Check if we have extensive content for this lesson
      const extensiveContent = testosteronEbookContent[lesson.title];
      
      if (extensiveContent) {
        try {
          const htmlContent = generateExtensiveEbookHTML(
            lesson.title,
          ...
          console.log(`      ✅ Generated extensive ebook: ${filename}`);
          ...
          console.error(`         ❌ Error generating extensive ebook:`, error.message);
          errorCount++;
        }
      } else {
        console.log(`      ⚠️ No extensive content found for: ${lesson.title}`);
      }
    ...
    console.log('======================');
    console.log(`Total lessons processed: ${lessons?.length || 0}`);
    console.log(`Extensive ebooks updated: ${updatedCount}`);
    console.log(`Errors encountered: ${errorCount}`);
    console.log(`Success rate: ${lessons && lessons.length > 0 ? Math.round(((lessons.length - errorCount) / lessons.length) * 100) : 0}%`);

    console.log('\n🎯 NEXT STEPS:');
    console.log('==============');
    console.log('1. Test the updated ebooks in the modal');
    console.log('2. Continue with other modules (Discipline, Fysieke Dominantie, etc.)');
    console.log('3. Generate PDF versions once all web versions are complete');
...
// Run the restoration
restoreExtensiveEbookContent().then(() => {
  console.log('\n✅ Extensive ebook content restoration completed');
  process.exit(0);
}).catch((error) => {
