...
async function updateAdsWithCorrectVideoStructure() {
  console.log('🎬 Updating ads with correct video structure...\n');
  
  try {
    // We know the video ID and image details from the manually updated ad
    ...
    const knownImageUrl = 'https://www.facebook.com/ads/image/?d=AQK1zdXWhqeE-wbOcTECiWlXMPeMmOhgsJgdtdIMS1LBWLWZeRyo_y38abnSKVXEu2YbAXRH3QTPiDXJbN_mbBlXtF49v5z_Hm90yh8pVebLA1Mi-977_JuZf4aj2VV_2PGImokti-GUA0lR9ebwPm_';
    ...
    for (const creative of creativesToUpdate) {
      ...
      // Create new creative with exact video_data structure (like the manually updated one)
      try {
...
updateAdsWithCorrectVideoStructure().catch(console.error);
