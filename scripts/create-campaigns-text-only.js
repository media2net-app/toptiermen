...
// All campaign configurations without page ID (text-only creatives)
const ALL_CAMPAIGNS = {
  algemene: {
...
async function createCampaignsTextOnly() {
  console.log('🚀 Creating All 4 Campaigns to Facebook (Text-Only Creatives)...\n');
  console.log(`📊 Ad Account ID: ${FACEBOOK_AD_ACCOUNT_ID}\n`);

  try {
    console.log('📝 Campaigns will be created with text-only creatives (no images)\n');
    ...
    console.log('3. Add images to ad creatives manually in Facebook Ads Manager');
    console.log('4. Link the Facebook page to ad creatives manually');
    console.log('5. Activate campaigns when ready');
    console.log('6. Monitor performance and adjust as needed');
    console.log('7. Focus on email collection for the prelaunch waitlist');
