    ...
    try {
      ...
      const correctPlans: NutritionPlan[] = [
        // CARNIVOOR PLANNEN
        {
          ...
          description: 'Een carnivoor voedingsplan specifiek gericht op vetverbranding en droogtrainen. Hoog in eiwitten, laag in koolhydraten, perfect voor het verliezen van lichaamsvet terwijl je spiermassa behoudt.',
          category: 'carnivoor',
