...
export default function VoedingsplannenPage() {
  ...
  const fetchNutritionPlans = async () => {
    try {
      ...
      // For now, we'll use the correct 3 plans that should exist
      const correctPlans: NutritionPlan[] = [
        {
          plan_id: 'carnivoor_animal_based',
        ...
        {
          plan_id: 'keto_optimalisatie',
          name: 'Keto Optimalisatie',
          description: 'Een ketogeen voedingsplan gericht op vetverbranding en mentale helderheid. Laag in koolhydraten, hoog in gezonde vetten.',
          category: 'keto',
