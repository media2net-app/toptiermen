        ...
        <div className="bg-[#181F17] border border-[#3A4D23] rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-lg p-4 text-center">
              ...
              <div className="text-xs text-gray-500">Doel: {planData.planTargets?.target_protein || 0}g</div>
              {(() => {
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-lg p-4 text-center">
              ...
              <div className="text-sm text-gray-400">Koolhydraten</div>
              <div className="text-xs text-gray-500">Doel: {planData.planTargets?.target_carbs || 0}g</div>
              {(() => {
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-lg p-4 text-center">
              ...
              <div className="text-xs text-gray-500">Doel: {planData.planTargets?.target_fat || 0}g</div>
              {(() => {
