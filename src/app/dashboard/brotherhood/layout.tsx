          ...
          <div className="relative p-6 sm:p-8">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                {/* Main Title */}
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-[#FFD700] to-[#8BAE5A] mb-3 drop-shadow-lg">
                  Brotherhood
                </h1>
                
                {/* Subtitle */}
                <p className="text-[#8BAE5A] text-lg md:text-xl font-medium leading-relaxed max-w-2xl">
