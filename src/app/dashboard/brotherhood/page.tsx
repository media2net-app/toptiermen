...
export default function Brotherhood() {
  ...
  return (
    <ClientLayout>
      <PageLayout 
        title="Brotherhood"
        subtitle="Je community van gelijkgestemde mannen"
            ...
            {challenges.map((challenge) => (
              <div key={challenge.id} className="bg-[#232D1A]/80 rounded-2xl p-6 shadow-xl border border-[#3A4D23]/40">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full px-4 py-2 rounded-xl bg-gradient-to-r from-[#8BAE5A] to-[#f0a14f] text-[#181F17] font-semibold shadow hover:from-[#B6C948] hover:to-[#8BAE5A] transition-all">
                    Doe mee
                  </button>
                </div>
              </div>
