        ...
        <div className="w-full max-w-md p-8 rounded-3xl shadow-2xl bg-[#232D1A]/95 border border-[#3A4D23] backdrop-blur-lg relative z-10">
          ...
          <div className="flex flex-col gap-6">
            <div className="relative">
              <select className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#181F17] text-[#B6C948] focus:outline-none focus:ring-2 focus:ring-[#B6C948] border border-[#3A4D23] mb-4 appearance-none font-figtree">
