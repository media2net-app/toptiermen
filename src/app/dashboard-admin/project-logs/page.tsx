        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-xl p-6">
              ...
              <p className="text-2xl font-bold text-[#8BAE5A]">{summary?.average_hours_per_day.toFixed(1) || 0}h</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-xl p-6">
              ...
              <p className="text-2xl font-bold text-[#8BAE5A]">{budgetData?.budget_percentage_used?.toFixed(1) || 0}%</p>
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-xl p-6">
              ...
              <p className="text-2xl font-bold text-[#8BAE5A]">{budgetData?.total_hours_remaining?.toFixed(1) || 123}h</p>
            ...
            <div className="bg-[#232D1A] border border-[#3A4D23] rounded-xl p-6">
              ...
              <p className="text-2xl font-bold text-[#8BAE5A]">{budgetData?.total_hours_overspent?.toFixed(1) || 0}h</p>
