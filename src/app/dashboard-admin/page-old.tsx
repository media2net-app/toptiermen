          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <AdminStatsCard
                ...
                value={loadingLedenStats ? '...' : realLedenStats.activeMembersThisMonth}
                icon={<UserGroupIcon className="w-8 h-8" />}
                color="green"
                loading={loadingLedenStats}
              />
              <AdminStatsCard
                title="Nieuwe aanmeldingen deze week"
                value={loadingLedenStats ? '...' : realLedenStats.newRegistrationsThisWeek}
              ...
              <AdminStatsCard
                ...
                value={loadingLedenStats ? '...' : realLedenStats.averageDailyLogins}
              ...
              <AdminStatsCard
                ...
                value={loadingLedenStats ? '...' : realLedenStats.activeCoachingPackages}
