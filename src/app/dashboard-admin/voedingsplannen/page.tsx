...
// Mock data
const voedingItems = [
  { id: '1', name: 'Havermout', category: 'Granen', calories: 389, protein: 16.9, carbs: 66.3, fat: 6.9 },
  { id: '2', name: 'Whey eiwit Shakes', category: 'Eiwitten', calories: 120, protein: 25, carbs: 3, fat: 1.5 },
  { id: '3', name: 'Volkoren crackers', category: 'Granen', calories: 350, protein: 12, carbs: 65, fat: 8 },
  { id: '4', name: 'Rijstwafels', category: 'Granen', calories: 35, protein: 0.8, carbs: 7.5, fat: 0.2 },
  { id: '5', name: 'Pindakaas', category: 'Vetten', calories: 588, protein: 25, carbs: 20, fat: 50 },
  { id: '6', name: 'Volkoren en groenten wraps', category: 'Granen', calories: 280, protein: 10, carbs: 50, fat: 4 },
  { id: '7', name: 'Blauwe bessen', category: 'Fruit', calories: 57, protein: 0.7, carbs: 14.5, fat: 0.3 },
  { id: '8', name: 'Bananen', category: 'Fruit', calories: 89, protein: 1.1, carbs: 23, fat: 0.3 },
  { id: '9', name: 'Appels', category: 'Fruit', calories: 52, protein: 0.3, carbs: 14, fat: 0.2 },
  { id: '10', name: 'Melk', category: 'Zuivel', calories: 42, protein: 3.4, carbs: 5, fat: 1 },
  { id: '11', name: 'Kipfilet plakjes', category: 'Vlees', calories: 165, protein: 31, carbs: 0, fat: 3.6 },
  { id: '12', name: 'Kipfilet', category: 'Vlees', calories: 165, protein: 31, carbs: 0, fat: 3.6 },
  { id: '13', name: 'Carpaccio', category: 'Vlees', calories: 250, protein: 25, carbs: 0, fat: 15 },
  { id: '14', name: 'Blikjes tonijn olijfolie', category: 'Vis', calories: 200, protein: 30, carbs: 0, fat: 8 },
  { id: '15', name: 'Salades', category: 'Groente', calories: 25, protein: 2, carbs: 5, fat: 0.3 },
  { id: '16', name: 'Eieren', category: 'Zuivel', calories: 155, protein: 13, carbs: 1.1, fat: 11 },
  { id: '17', name: 'Kaas', category: 'Zuivel', calories: 400, protein: 25, carbs: 1, fat: 33 },
  { id: '18', name: 'Krentenbol', category: 'Granen', calories: 280, protein: 8, carbs: 55, fat: 3 },
  { id: '19', name: 'Koolhydraten arm brood', category: 'Granen', calories: 200, protein: 12, carbs: 25, fat: 8 },
  { id: '20', name: 'Basmati Rijst', category: 'Granen', calories: 130, protein: 2.7, carbs: 28, fat: 0.3 },
  { id: '21', name: 'Volkoren pasta', category: 'Granen', calories: 124, protein: 5, carbs: 25, fat: 1.1 },
  { id: '22', name: 'Noodles', category: 'Granen', calories: 110, protein: 4, carbs: 22, fat: 0.5 },
  { id: '23', name: 'Spaghetti', category: 'Granen', calories: 124, protein: 5, carbs: 25, fat: 1.1 },
  { id: '24', name: 'Macaroni', category: 'Granen', calories: 124, protein: 5, carbs: 25, fat: 1.1 },
  { id: '25', name: 'Zoete aardappel', category: 'Groente', calories: 86, protein: 1.6, carbs: 20, fat: 0.1 },
  { id: '26', name: 'Witte aardappel', category: 'Groente', calories: 77, protein: 2, carbs: 17, fat: 0.1 },
  { id: '27', name: 'Witvis', category: 'Vis', calories: 100, protein: 20, carbs: 0, fat: 2 },
  { id: '28', name: 'Mager rundergehakt', category: 'Vlees', calories: 250, protein: 26, carbs: 0, fat: 15 },
  { id: '29', name: 'Biefstuk', category: 'Vlees', calories: 271, protein: 26, carbs: 0, fat: 18 },
  { id: '30', name: 'Kip', category: 'Vlees', calories: 165, protein: 31, carbs: 0, fat: 3.6 },
  { id: '31', name: 'Kalkoenfilet', category: 'Vlees', calories: 135, protein: 30, carbs: 0, fat: 1 },
  { id: '32', name: 'Tartaar', category: 'Vlees', calories: 250, protein: 25, carbs: 0, fat: 15 },
  { id: '33', name: 'Duitse biefstuk', category: 'Vlees', calories: 271, protein: 26, carbs: 0, fat: 18 },
  { id: '34', name: 'Magere kwark', category: 'Zuivel', calories: 59, protein: 10, carbs: 3.6, fat: 0.4 },
  { id: '35', name: 'Skyr', category: 'Zuivel', calories: 59, protein: 10, carbs: 3.6, fat: 0.4 },
  { id: '36', name: 'Walnoten', category: 'Noten', calories: 654, protein: 15, carbs: 14, fat: 65 },
  { id: '37', name: 'Amandelen', category: 'Noten', calories: 579, protein: 21, carbs: 22, fat: 50 },
  { id: '38', name: 'Halfvolle kwark', category: 'Zuivel', calories: 80, protein: 12, carbs: 4, fat: 2 },
];
            ...
            <div className="bg-[#181F17] rounded-xl p-6 border border-[#3A4D23]/40">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <option value="all">Alle categorieën</option>
                    {Array.from(new Set(voedingItems.map(item => item.category))).map(category => (
                      <option key={category} value={category}>{category}</option>
                    ))}
                  </select>
                </div>
