...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/admin/prelaunch-emails-local:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/admin/prelaunch-emails-local:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Error in PUT /api/admin/prelaunch-emails-local:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error in DELETE /api/admin/prelaunch-emails-local:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
} 