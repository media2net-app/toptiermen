...
const navigation = [
  ...
  { name: 'Campagnes', href: '/dashboard-marketing/campagnes', icon: ChartBarIcon },
          { name: 'API Advertentie maken', href: '/dashboard-marketing/api-advertentie-maken', icon: WrenchScrewdriverIcon, badge: 'API' },
        { name: 'Email Campagnes', href: '/dashboard-marketing/email-campagnes', icon: EnvelopeIcon, badge: 'NEW' },
