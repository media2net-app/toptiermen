...
const translations = {
  nl: {
    title: 'Video Ideeën',
    subtitle: 'Malaga',
    description: 'Ontdek de exclusieve video concepten die Rick in Malaga gaat opnemen voor de Top Tier Men community',
    daysUntilLaunch: 'Dagen tot Launch',
    september: 'September',
    topTierMen: 'Top Tier Men',
    totalVideos: 'Totaal Video\'s',
    highPriority: 'Hoog Prioriteit',
    malagaLocations: 'Malaga Locaties',
    ...
    deadlineText: 'Uiterlijke opleverdatum voor alle video\'s: 22 augustus 2025',
    campaignStart: 'Video campagnes starten op 3 september 2025 - 1 week voor lancering 10 september',
    ...
    deadlineContext: 'Voor video campagne start 25-08-2025',
    by: 'Door:',
    priority: 'Prioriteit',
    status: 'Status'
  },
  en: {
    title: 'Video Ideas',
    subtitle: 'Malaga',
    description: 'Discover the exclusive video concepts that Rick will film in Malaga for the Top Tier Men community',
    daysUntilLaunch: 'Days until Launch',
    september: 'September',
    topTierMen: 'Top Tier Men',
    totalVideos: 'Total Videos',
    highPriority: 'High Priority',
    malagaLocations: 'Malaga Locations',
    ...
    low: 'Low',
    deadlineAlert: '⚠️ Deadline Alert',
    deadlineText: 'Final delivery deadline for all videos: August 22, 2025',
    campaignStart: 'Video campaigns start on September 3, 2025 - 1 week before September 10 launch',
    ...
    deadlineContext: 'For video campaign start 25-08-2025',
    by: 'By:',
    priority: 'Priority',
    status: 'Status'
  }
...
const videoIdeasData: VideoIdeaData[] = [
  {
    id: '1',
    title: 'Become a Top Tier Man - Malaga Sunrise Motivation',
    description: {
      nl: 'Rick op een Malaga klif tijdens zonsopgang, sprekend over wat het betekent om een Top Tier Man te zijn. Motiverende voice-over over discipline en mindset.',
      en: 'Rick on a Malaga cliff during sunrise, speaking about what it means to be a Top Tier Man. Motivational voice-over about discipline and mindset.'
    },
    category: 'promotie',
    priority: 'hoog',
    status: 'concept',
    location: {
      nl: 'Gibralfaro Kasteel (Zonsopgang)',
      en: 'Gibralfaro Castle (Sunrise)'
    },
    estimatedDuration: {
      nl: '30-45 seconden',
      en: '30-45 seconds'
    ...
    keyMessages: ['Become a Top Tier Man', 'Discipline', 'Mindset', 'Launch 10 September', 'Pre-register now'],
    requiredProps: {
      nl: ['Camera setup', 'Microfoon', 'Zonsopgang timing', 'Countdown overlay'],
      en: ['Camera setup', 'Microphone', 'Sunrise timing', 'Countdown overlay']
    },
    notes: {
      nl: 'Opname tijdens zonsopgang (7:00 AM). Rick spreekt direct in camera over Top Tier Man concept. HOOK: Start met spectaculaire drone shot van kasteel en Rick silhouette.',
      en: 'Recording during sunrise (7:00 AM). Rick speaks directly to camera about Top Tier Man concept. HOOK: Start with spectacular drone shot of castle and Rick silhouette.'
    },
    cameraInstructions: 'CAMERA: Start with dramatic drone shot of castle and Rick silhouette. Wide shot of Rick on castle walls with sunrise background. Rick in center frame, castle and sea visible. Medium close-up shots for emotion. Ensure golden hour lighting. STABILIZATION: Gimbal or tripod for smooth movements. AUDIO: Lavalier microphone for Rick, wind protection. LIGHTING: Natural light, ND filter for sunrise. COMPOSITION: Rule of thirds, Rick on 1/3 line, sunrise on 2/3. DRONE: Aerial shots of castle and Rick for opening/closing. HOOK: First 3 seconds must be visually stunning with dramatic sunrise and Rick silhouette.',
    dutchScript: 'Discipline is de brug tussen doelen en prestaties. Ben je klaar om een Top Tier Man te worden? Lancering 10 september. Pre-registreer nu voor exclusieve vroege toegang.',
  ...
  },
  {
    ...
    status: 'concept',
    location: {
      nl: 'Malaga Boxing Gym',
      en: 'Malaga Boxing Gym'
    },
    estimatedDuration: {
      nl: '45-60 seconden',
      en: '45-60 seconds'
    ...
    dutchScript: 'Discipline is doen wat er gedaan moet worden, ook als je er geen zin in hebt. Dit is wat Top Tier Men onderscheidt van de rest. Ben je klaar om je grenzen te verleggen? Lancering 10 september.',
  ...
  {
    id: '3',
    title: 'Malaga Beach Meditation - Mindset Mastery',
    description: 'Rick op een rustige Malaga beach, mediterend en sprekend over mindset en mentale kracht.',
    category: 'lifestyle',
    priority: 'medium',
    status: 'concept',
    ...
    dutchScript: 'Je mindset bepaalt je realiteit. Top Tier Men beheersen hun gedachten voordat ze hun acties beheersen. Lancering 10 september.',
  ...
  {
    id: '4',
    title: 'Sunset Countdown - 10 September Launch',
    description: 'Rick op Malaga sunset point met countdown naar 10 september. Krachtige call-to-action voor pre-registratie.',
    category: 'promotie',
    priority: 'hoog',
    status: 'concept',
    location: 'Mirador de Gibralfaro',
    estimatedDuration: '20-30 seconden',
    targetAudience: 'Alle potentiële leden',
    keyMessages: ['Countdown to Launch', 'Pre-register now', 'Exclusive Access', '10 September'],
    ...
    cameraInstructions: 'CAMERA: Start with spectacular sunset time-lapse. Wide shot of Rick with Malaga skyline background. Medium close-up for countdown moment. Rick in silhouette against sunset. STABILIZATION: Tripod for stable shots. AUDIO: Lavalier microphone, wind protection. LIGHTING: Sunset lighting, Rick in silhouette, Malaga skyline illuminated. COMPOSITION: Rick on 1/3 line, skyline on 2/3. DRAMATIC: Silhouette shots of Rick against sunset. B-ROLL: Time-lapse of sunset, Malaga skyline shots. OVERLAY: Countdown timer in post-production. HOOK: First 3 seconds must show dramatic sunset time-lapse with Malaga skyline.',
    dutchScript: 'De countdown is begonnen. 10 september 2025. Word een Top Tier Man. Pre-registreer nu voor exclusieve vroege toegang. Mis je kans niet om bij de elite te horen.',
  ...
  {
    id: '5',
    title: 'Malaga Villa Lifestyle - Success Mindset',
    description: 'Rick in een Malaga villa, sprekend over succes mindset en hoe Top Tier Men leven en denken.',
    category: 'lifestyle',
    priority: 'medium',
    status: 'concept',
    location: 'Luxury Malaga Villa',
    ...
    dutchScript: 'Succes is niet toevallig. Top Tier Men denken anders, handelen anders, leven anders. Sluit je aan bij de elite. Lancering 10 september.',
  ...
  },
  {
    ...
    description: 'Rick doet een beach workout op Malaga, toont fysieke discipline en motivatie.',
    category: 'lifestyle',
    priority: 'medium',
    status: 'concept',
    ...
    dutchScript: 'Discipline is consistentie in actie. Elke rep, elke set, elke dag. Zo bouwen Top Tier Men hun lichaam en karakter op. Ben je klaar om te committeren? Lancering 10 september.',
  ...
  },
  {
    ...
    description: 'Rick op een Malaga rooftop, sprekend over wat het betekent om elite te worden en deel te zijn van Top Tier Men.',
    category: 'promotie',
    priority: 'hoog',
    status: 'concept',
    location: 'Malaga Rooftop Terrace',
    estimatedDuration: '45-60 seconden',
    ...
    notes: 'Rick op rooftop met Malaga uitzicht. HOOK: Start met spectaculair city skyline shot.',
    cameraInstructions: 'CAMERA: Start with spectacular city skyline shot. Wide shot of Rick on rooftop with Malaga skyline. Medium close-up for motivation moments. Rick in center with city view background. STABILIZATION: Tripod for stable shots. AUDIO: Lavalier microphone, wind protection. LIGHTING: Golden hour light, city lights in background. COMPOSITION: Rick on 1/3 line, city view on 2/3. DRAMATIC: Rick in silhouette against sunset/city lights. B-ROLL: City skyline, rooftop details, Malaga landmarks. MOVEMENT: Slow pan from city view to Rick. HOOK: First 3 seconds must show dramatic city skyline with sunset colors.',
    dutchScript: 'Elite is geen titel, het is een keuze. Top Tier Men kiezen elke dag voor excellentie. Sluit je aan bij de meest exclusieve community van high performers. Lancering 10 september. Pre-registreer nu.',
  ...
  },
  {
    ...
    description: 'Rick in Malaga nightclub setting, sprekend over succes mindset en de energie van Top Tier Men.',
    category: 'lifestyle',
    priority: 'medium',
    status: 'concept',
    location: 'Malaga Nightclub',
    estimatedDuration: '30-45 seconden',
    ...
    dutchScript: 'Top Tier Men weten hoe ze hard moeten werken en hard moeten spelen. Succes gaat niet alleen over business, het gaat over het leven ten volste leven. Sluit je aan bij de elite. Lancering 10 september.',
...
export default function VideoIdeeenMalagaPage() {
  ...
  // Calculate days until September 10th, 2025
       ...
       <div className="px-4 sm:px-6 py-8 sm:py-12">
         <div className="max-w-7xl mx-auto">
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
               ...
               <div className="flex items-center justify-between">
                 <div>
                   <p className="text-gray-400 text-xs sm:text-sm">{t.malagaLocations}</p>
