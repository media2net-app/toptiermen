-- Insert lessons for module 4: Finance & Business (Fixed version)
...
<li>Risico\'s: onderhoud, leegstand</li>
</ul>
...
<p>Advertentie-inkomsten van video\'s:</p>
<ul>
...
<p>Foto\'s en video\'s verkopen:</p>
<ul>
